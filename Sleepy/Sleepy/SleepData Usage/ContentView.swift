...
struct ContentView: View {
    ...
    @StateObject private var health = HealthManager(requestAuthorization: false) // 🔹 Creiamo l'oggetto senza autorizzazione all'inizio
    ...
    var body: some View {
        ...
        .sheet(isPresented: $showWelcomeSheet) {
            WelcomeView(onDismiss: {
                ...
                showWelcomeSheet = false // 🔹 Quando l'utente chiude la WelcomeView, chiudiamo il sheet
            }, health: health)
